...
/// <summary>
/// Модуль обробки тексту на основі String та StringBuilder.
/// </summary>
public static class TextProcessor
{
    ...
    /// <summary>
    /// Підраховує символи з опцією ігнорування пробілів.
    /// </summary>
    ...
    /// <summary>
    /// Нормалізує текст: Trim і видалення зайвих пробілів.
    /// </summary>
    ...
    /// <summary>
    /// Замінює кілька підрядків за словником замін.
    /// </summary>
    ...
    /// <summary>
    /// Генерує красивий звіт групи через StringBuilder.
    /// </summary>
    ...
    /// <summary>
    /// Порівнює продуктивність конкатенації string і StringBuilder.
    /// </summary>
    ...
    /// <summary>
    /// Варіант 5: генерує SQL-запит на основі текстового опису українською.
    /// </summary>

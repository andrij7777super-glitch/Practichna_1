...
/// <summary>
/// Двовимірна матриця портів 16×16 для симуляції вводу/виводу.
/// </summary>
public class PortMatrix
{
    ...
    /// <summary>
    /// Ініціалізує матрицю 16×16, створюючи порти з унікальними номерами.
    /// </summary>
    ...
    /// <summary>
    /// Відкриває порт за координатами матриці.
    /// </summary>
    ...
    /// <summary>
    /// Закриває порт за координатами матриці.
    /// </summary>
    ...
    /// <summary>
    /// Записує дані у буфер порту (максимум 64 байти).
    /// </summary>
    ...
    /// <summary>
    /// Сканує матрицю та повертає список відкритих портів.
    /// </summary>
    ...
    /// <summary>
    /// Шукає відкритий порт за номером у двовимірному масиві.
    /// </summary>
    ...
    /// <summary>
    /// Формує красиве текстове представлення стану матриці через StringBuilder.
    /// </summary>
    ...
    /// <summary>
    /// Експортує стан матриці для серіалізації JSON.
    /// </summary>
    ...
    /// <summary>
    /// Відновлює стан матриці зі збережених даних.
    /// </summary>
    ...
    /// <summary>
    /// Перевіряє, чи ініціалізована матриця.
    /// </summary>
...
/// <summary>
/// Знімок стану комірки матриці портів для збереження.
/// </summary>

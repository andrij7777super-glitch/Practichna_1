...

{
    ...
    public event Action<double>? GradeChanged;
    ...
    public StudentRecord GetRecord() => new(FullName, RecordBookNumber, AverageGrade);
    ...
    public bool HasPassedAllLabs() =>

        LabGrades.Where(g => g > 0).All(g => g >= 60);
...

    {
        ...
        GradeChanged?.Invoke(_averageGrade);
